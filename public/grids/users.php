  ...
  $(function()
  {
    ...
    jQuery("#grid_users").jqGrid({
        ...
        colModel :[ 
          ...
          {name:'password', index:'password', width:10, align:'left', sortable:true, editable:true, editoptions: {size:30}, search:true},
          // {name:'email', index:'email', width:15, align:'left', sortable:true, editable:false, editoptions: {size:30}, search:true},
          // {name:'firstname', index:'firstname', width:5, align:'left', sortable:true, editable:false, editoptions: {size:30}, search:true},
          // {name:'middlename', index:'middlename', width:5, align:'left', sortable:true, editable:false, editoptions: {size:30}, search:true},
          // {name:'lastname', index:'lastname', width:5, align:'left', sortable:true, editable:false, editoptions: {size:30}, search:true},
          // {name:'birthdate', index:'birthdate', width:10, align:'left', sortable:true, editable:false, editoptions: {size:30}, search:true},
          // {name:'gender', index:'gender', width:5, align:'left', sortable:true, editable:false, search:true, formatter:genderFormat, edittype:'select', editoptions:{value:{1:'MALE', 2:'FEMALE'}}},
          // {name:'twitterid', index:'twitterid', width:5, align:'left', sortable:true, editable:false, editoptions: {size:30}, search:true},
          // {name:'facebookid', index:'facebookid', width:5, align:'left', sortable:true, editable:false, editoptions: {size:30}, search:true},
          // {name:'foursquareid', index:'foursquareid', width:5, align:'left', sortable:true, editable:false, editoptions: {size:30}, search:true},
          // {name:'scoreloopid', index:'scoreloopid', width:5, align:'left', sortable:true, editable:false, editoptions: {size:30}, search:true},
          {name:'pending', index:'pending', width:5, align:'left', sortable:true, editable:true, search:true, formatter:statusFormat, edittype:'select', editoptions:{value:{0:'APPROVED', 1:'PENDING'}}},
          {name:'enabled', index:'enabled', width:5, align:'left', sortable:true, editable:true, search:true, formatter:accessFormat, edittype:'select', editoptions:{value:{0:'DISABLED', 0:'ENABLED'}}},
